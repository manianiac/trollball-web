import { TEAMS } from "../shared/teams"; // Adjust path to your TEAMS file
import { team } from "../shared/types"; // Adjust path to your consts file
import { seededShuffle } from "../shared/utils";
