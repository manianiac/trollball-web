...
export const GAMES: match[] = [
  ...
  },
  {
    ...
    preGame:
      "\"Hello, OSTERRA! This is Nok the Corrupter, coming to you live from a pile of beautiful, crumbling rocks known as **The Old Fort**! Oh, the atmosphere is just electric! We've got dense fog rolling in, the players are trying not to twist an ankle on the 'uneven footing,' and it is magnificent!\n\nOur home team, **The Kerlauger Runeguard**, is looking stoic as ever. They are *serious* about their warm-ups. I saw their healer, Eal Caundra, reciting a very long list of legendary players, and Gurney Fadiman just raised a toast of... is that *goat's milk*?... to their rivals. How quaint! My favorite, though, is Lashondra Niehaus, who's getting a teammate to punch them in the shoulder just to get ready. Now that's commitment!\n\nAnd the visiting **Zmeigorod Snessengers**! Oh, these swamp-folk know how to prepare for a game! Their healer, Waldon Tadeo, is rubbing a *foul-smelling mushroom* on their elbows! Delija Dowling just chugged a raw egg, shell and all! And Evalyn Pierrepont—you're not gonna believe this—is polishing their helmet with a *live snail* for good luck! You just don't get this kind of high-class entertainment in a palace.\n\nThe whistle is about to blow on this foggy, rocky, beautiful mess! It's the Runeguard versus the Snessengers! Don't you go anywhere!\"",
    postGame:
      "\"And that’s the game! The home team has done it! **The Kerlauger Runeguard** holds the line and shuts out the Snessengers, **2 to 0**!\n\nThis game was a messy, glorious brawl from start to finish! The Snessengers just couldn't hang onto the ball—it was all fumbles and missed throws for them. But the Runeguard? Oh, they found their footing!\n\nWe saw a beautiful play from Gurney Fadiman, who hit **Reginauld Cordell** with a perfect pass right in scoring range! Cordell saw the opening, charged, and put that troll head right in the basket! What a score!\n\nAnd then, after the half, it was **Lashondra Niehaus**—who was getting punched for fun before the game—who scooped up the ball, stared down Avaria Revell, and just *sank* another one for the home team!\n\nThe Snessengers fought hard—Delija Dowling was out there knocking players down left and right—but they couldn't find the basket. A decisive 2-0 victory for The Kerlauger Runeguard here in their own crumbling, foggy backyard! What a wonderful display of controlled violence!\n\nThis has been Nok the Corrupter, signing off from The Old Fort. Go find a snail to polish your helmet with! Now, go cause some trouble!\"",
    week: 1,
    homeScore: 2,
    awayScore: 0,
    slug: "kerlauger-zmeigorod-1",
  },
];
