import { ALL_ACTIONS, match_progress, player, ZONE } from "@/shared/types";
import {
  calculateSuccess,
  advanceZone,
  handleScore,
...
export const run = (
  ...
  if (
    ...
    if (
      ...
      gameState = handleScore(
        gameState,
        activePlayer.team === gameState.homeTeam.name ? "home" : "away",
        points,
        description,
      );
    } else {
