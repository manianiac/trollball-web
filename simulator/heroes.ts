...
export const heroesOfTheRealm = [
  {
    ...
    characters: [
      ...
      "Governor-King Zenku, who is ashamed of his face",
      "Notable Fey Hater Linaius",
  ...
  {
    faction: "The Grove",
    associatedTeams: [TEAM_NAMES["The Zmeigorod Snessengers"]],
    characters: [
      "Count Trez Arrigo, the former pirate, merchant prince, captain of commerce, who wooed his high priestess",
      "High Priestess Oona of the Green Goddess, executor of my corrupted friends",
  ...
  },
  {
    ...
    characters: [
      ...
      "Chairman High Venture Brennen Farno, money priest, kissless virgin, strangely beautiful, probably re-released the Plagues of Festar",
  ...
  },
  {
    ...
    associatedTeams: [TEAM_NAMES["The New Monteforte Chaos Creatures"]],
    characters: [
  ...
  {
    faction: "Cedar Hill",
    associatedTeams: [TEAM_NAMES["The Tortell Privateers"]],
    characters: [
      "Imra, Master of Elixers, Dust Afficionado. Seriously, pay your bar tab, averted several wars (boo)",
      "Elspeth Ortell, Osterra's friendliest person who “makes things happen”, makes a mean ritual sangria, almost a money priestess, likes to walk and talk",
  ...
  {
    faction: "The Wardens",
    associatedTeams: [TEAM_NAMES["Oak & Onslaught"]],
    characters: [
  ...
  {
    faction: "Mellondor",
    associatedTeams: [TEAM_NAMES["The Dark Tree Demon Kids"]],
    characters: [
  ...
  {
    faction: "Blackthorn",
    associatedTeams: [TEAM_NAMES["The New Noxus Thorns"]],
    characters: [],
  },
  {
    faction: "The House of Silver Branches",
    associatedTeams: [],
    characters: [],
  },
  {
    faction: "The Choir of the End Times",
    associatedTeams: [],
    characters: [],
  },
  {
    faction: "The Vidarians",
    associatedTeams: [],
    characters: [],
  },
  {
